...
COMMENT ON COLUMN patient_budgets.clinic_id IS 'Referência à clínica (multi-tenant)';
...
-- Policy: INSERT - Apenas ADMIN e RECEPCAO podem inserir pagamentos
...
COMMENT ON COLUMN payments.clinic_id IS 'Referência à clínica (multi-tenant)';
...
-- Exemplo 1: Criar/atualizar orçamento
/*
...
-- Exemplo 4: Buscar pagamentos de um paciente
/*
SELECT 
  pay.*,
...
-- Exemplo 6: Relatório financeiro da clínica
/*
SELECT 
  patient_name,
  budget_total,
