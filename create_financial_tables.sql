...
COMMENT ON COLUMN patient_budgets.clinic_id IS 'Referencia a clinica (multi-tenant)';
...
COMMENT ON COLUMN payments.clinic_id IS 'Referencia a clinica (multi-tenant)';
