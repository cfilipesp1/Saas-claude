...
-- VERSÃO LIMPA - Remove tabelas existentes antes de criar
-- =====================================================

-- ⚠️ ATENÇÃO: Este script remove as tabelas appointments e profiles se existirem
-- Certifique-se de fazer backup se houver dados importantes

-- =====================================================
-- LIMPEZA: Remover tabelas existentes
-- =====================================================

-- Remover tabela appointments (se existir)
...
CREATE INDEX idx_appointments_dentista_atendente ON appointments(dentista_atendente_id);
CREATE INDEX idx_appointments_tipo ON appointments(tipo_atendimento);
